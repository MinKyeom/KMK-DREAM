...
export default async function PostDetailPage({ params }) {
    ...
    return (
        <div className="post-detail-container" style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 0' }}>
            <article>
                {/* 1. 포스트 제목 및 메타 정보 */}
                <h1 
                    style={{ 
                ...
                <div style={{ 
                    ...
                    <span style={{ color: 'var(--color-text-sub)' }}>
                        ...
                        작성자: <span style={{ fontWeight: 600, color: 'var(--color-accent)' }}>{post.authorNickname || "작성자 알 수 없음"}</span>
                    </span>
